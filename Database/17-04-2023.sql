...
-- Dumping data for table core_shopcart.addresses: ~1 rows (approximately)
INSERT INTO `addresses` (`id`, `user_id`, `address_line1`, `address_line2`, `city`, `state`, `country`, `status`) VALUES
	...
	(3, 1, 'wet', 'rh', 'fdtj', 'hdftj', 'mdm', 1),
	(4, 1, 'dfmnd', 'dmdf', 'tth', 'dfthdf', 'dfthdth', 1),
	(5, 1, 'xcbxc', 'bxcvb', 'xcvb', 'xcvbx', 'cvbxcb', 1);
