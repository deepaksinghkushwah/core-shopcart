...
-- Dumping data for table core_shopcart.cart: ~0 rows (approximately)
INSERT INTO `cart` (`id`, `user_id`, `session_id`, `product_id`, `price`, `qty`, `created_at`) VALUES
	(6, 1, 'ml6ogb06tqasfa3stgoninh4vl', 238, 152.00, 2, '2023-04-20 09:16:00');
...
-- Dumping data for table core_shopcart.orders: ~2 rows (approximately)
INSERT INTO `orders` (`id`, `user_id`, `address_id`, `amount`, `created_at`, `payment_status`, `order_status`) VALUES
	(5, 1, 2, 0.00, '2023-04-20', 'paid', 'order placed'),
	(7, 1, 2, 452.00, '2023-04-20', 'paid', 'order placed');
...
-- Dumping data for table core_shopcart.order_details: ~2 rows (approximately)
INSERT INTO `order_details` (`id`, `order_id`, `product_id`, `title`, `price`, `qty`) VALUES
	(12, 5, 238, 'Aut laborum ad nobis quasi.', 5372413.50, 1),
	(13, 5, 236, 'Odio enim quisquam et facere.', 464022.47, 1),
	(15, 7, 238, 'Aut laborum ad nobis quasi.', 152.00, 1),
	(16, 7, 236, 'Odio enim quisquam et facere.', 300.00, 1);
...
INSERT INTO `products` (`id`, `title`, `price`, `description`, `image`, `cat_id`, `status`) VALUES
	...
	(229, 'Doloribus expedita ut ut.', 200.00, 'Qui mollitia ex et ipsum et ratione quidem. Atque ea qui sunt ex repudiandae quaerat et. Non ad autem consequuntur. Animi quaerat impedit tenetur qui facere et.', 'noimg.png', 14, 1),
	(230, 'Magni eum ipsa maxime.', 100.00, 'Aut doloribus voluptatem aut expedita ut ullam. Excepturi voluptatem est ut ratione ad magni non. Odit aut sequi eos non voluptatum hic.', 'noimg.png', 14, 1),
	(231, 'Et porro unde et dicta quis.', 500.00, 'Fugit debitis ad ut. Et dolores eligendi magnam omnis aut culpa. Aliquam accusamus harum voluptatem culpa eum. Consequatur vitae incidunt sint qui et ut labore. Minima consectetur consectetur tempore in aliquid rerum modi.', 'noimg.png', 14, 1),
	...
	(236, 'Odio enim quisquam et facere.', 300.00, 'Et animi voluptatum voluptatem facere quia est. Soluta est ducimus doloremque perspiciatis et. Qui accusantium ea voluptatem fugiat aut vel dolores. Culpa aut commodi nobis voluptate.', 'noimg.png', 14, 1),
	...
	(238, 'Aut laborum ad nobis quasi.', 152.00, 'Sint ut sit id dolore molestiae animi. Eos sequi officiis sint eligendi. Autem excepturi omnis ut distinctio natus. Ut aut quae sit laboriosam sed laboriosam.', 'noimg.png', 14, 1);
